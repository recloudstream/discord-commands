module.exports = {
  ...
  async execute(message) {
    ...
    },
    {
      ...
      "description": "This page covers the various apps recommended by the community, to enhance your media experience when using CS3.",
      "url": "https://cs3docs.pages.dev/recapps/",
      "color": 41983,
      "thumbnail": {
