      ...
      embeds: [
        {
          ...
          description:
            "You can use **warp** if DOH is not bypassing the geo restriction. WARP is a hassle-free alternative which is free. This vpn is for bypassing geo restriction. not for privacy (1.1.1.1 will show your real ip to the site that has Cloudflare).\n\nIf you want a vpn that respects your privacy, you can use [**Winscribe**](https://play.google.com/store/apps/details?id=com.windscribe.vpn) (free) or [**Mullvad**](https://play.google.com/store/apps/details?id=net.mullvad.mullvadvpn) (paid).",
          url: "https://cs3docs.pages.dev/more-stuff/vpn/#cloudflare-warp",
          color: 16740352,
          thumbnail: {
