module.exports = {
    ...
    async execute(message) {
      ...
      "description": "Superstream's servers are over loaded because of too much user traffic. So, the superstream extension is down. Cloudstream developers can't fix the issue.\n**The Fix release date has no ETA. So don't report about the issue.**",
      "color": null,
      "thumbnail": {
