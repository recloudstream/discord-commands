module.exports = {
  ...
  async execute(message) {
    message.channel.send({
      ...
      "description": "The standalone sflix extension in English repo is broken amd there is no eta. But there is an API for sflix.to in Sorastream. You can find the Sflix servers as **Upcloud** and **Vidcloud**. But use other sources like UHD, Gdrive movies, HDmoviebox, Uniquestream to get better qualities.",
      "color": 370579,
      "thumbnail": {
