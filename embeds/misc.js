{
  this.embeds = [{
      "title": "Miscellaneous softwares for cloudstream 3",
      "description": `
      
      :small_blue_diamond: External media player: [**MPV**](https://play.google.com/store/apps/details?id=is.xyz.mpv&hl=en&gl=US) \n
      ...
      :small_blue_diamond: Free vpn for android: [**1.1.1.1**](https://rentry.org/askvpn#cloudflare)
      `,
    }]
}
